...
const NOTIFY = {
  /* 口調の段階。app.js のセリフと同じ区切り（レベル＝親密度、上限は Lv100）。
       0: Lv1-30  「貴様」       1: Lv31-60 名前
       2: Lv61-90 「ご主人」     3: Lv91-100「ご主人様」 */
  tone(lv) { return lv >= 91 ? 3 : lv >= 61 ? 2 : lv >= 31 ? 1 : 0; },
  you(lv, name) {
    const n = (name || "").trim(), t = this.tone(lv);
    if (t === 3) return "ご主人様";
    if (t === 2) return "ご主人";
    if (t === 1) return n || "貴様";      // 名前が未設定なら前の段階の呼び方
    return "貴様";
  },
  ...
  lines: {
    tomorrow: [
      ...
      ["明日はこれがある。支度はしておけ、{you}。", "明日だ、{you}。忘れるな。"],
      ["{you}、明日はこれがある。……覚えているか。", "明日だな、{you}。忘れないでくれ。"],
      ["{you}、明日はこちらのご予定があります。", "明日です、{you}。お忘れなきよう。"]
    ],
    todayTime: [
      ["{time}からだ。そろそろ動け、{you}。", "あと少しで{time}だぞ。"],
      ["もうすぐ{time}だ。支度しろ、{you}。", "{time}からだ、{you}。"],
      ["{you}、{time}からだ。……そろそろだな。", "もうすぐ{time}だ。いってこい、{you}。"],
      ["{you}、まもなく{time}です。お支度を。", "{time}からです。……いってらっしゃいませ。"]
    ],
    todayAny: [
      ["今日だ。忘れるなよ、{you}。", "今日はこれがある。やっておけ。"],
      ["今日はこれがある。忘れるなよ、{you}。", "今日だ、{you}。"],
      ["{you}、今日はこれがある。", "今日だな。……忘れないうちに。"],
      ["{you}、本日はこちらのご予定があります。", "本日です。お忘れなきよう。"]
    ],
    ahead: [
      ["{date}だ。覚えておけ、{you}。", "{date}にこれがある。忘れるなよ。"],
      ["{date}にこれがある。覚えておけ、{you}。", "{date}だ、{you}。"],
      ["{you}、{date}にこれがある。", "{date}だな。……覚えておいてくれ。"],
      ["{you}、{date}にこちらのご予定があります。", "{date}です。お心づもりを。"]
    ]
  },
